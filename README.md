...
HTML research dashboard generated by `python -m dashboard build` from `artifacts/demo/`.

![Dashboard Overview](docs/dashboard_overview.png)

Executive summary and key metrics loaded from `metrics.json`.

![Dashboard Summary](docs/dashboard_summary.png)

Pipeline structure, model comparison table, and experiment metadata.

![Dashboard Charts](docs/dashboard_charts.png)

Plotly charts: deflated Sharpe decay, walk-forward folds, equity curve, and cost sensitivity.

![Dashboard Validation](docs/dashboard_validation.png)

Validation configuration, fold table, feature set, trial ledger, and artifact inventory.
